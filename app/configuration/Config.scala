 ...
 object Identity {
  ...
  def demoPromo(env: String) = {
    ...
    Promotion(
      ...
      description = "Get £30 to spend with a top retailer of your choice when you subscribe. Use your digital gift card at John Lewis, Amazon.co.uk, M&S and more. Treat yourself or a friend.",
