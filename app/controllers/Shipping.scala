  ...
  def viewCollectionPaperDigital() = NoCacheAction.async {
    ...
    catalog.map { catalog =>
      index(CollectionSubscriptionProduct(
        ...
        description = "Save money on your newspapers and digital content. Plus start using The Guardian Daily and premium access to The Guardian Live app immediately.",
